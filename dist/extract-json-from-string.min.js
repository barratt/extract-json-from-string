...
var jsonify = function jsonify(almostJson) {
  try {
    return JSONbig.parse(almostJson);
  } catch (e) {
...
var json_stringify = __webpack_require__(3).stringify;
var json_parse     = __webpack_require__(4);
  ...
  var at, // The index of the current character
    ...
    number = function () {
      ...
      if (!isFinite(number)) {
        ...
        if (BigNumber == null) BigNumber = __webpack_require__(0);
